...
d3.json('https://raw.githubusercontent.com/Uthkarshh/Scientific-Data-Visualization-Project/main/world.GeoJSON').then(function (world) {
    renderMap(world);
...
function updateMap(world) {
    ...
    d3.csv('https://raw.githubusercontent.com/Uthkarshh/Scientific-Data-Visualization-Project/main/Covid%20Data.csv', function (d) {
